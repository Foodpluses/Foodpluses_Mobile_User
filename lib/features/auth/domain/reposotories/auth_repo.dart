...
import 'package:stackfood_multivendor/helper/device_info_helper.dart';
import 'package:stackfood_multivendor/helper/location_helper.dart';
...
class AuthRepo implements AuthRepoInterface<SignUpBodyModel> {
  ...
  Future<Response> registration(SignUpBodyModel signUpModel) async {
    ...
    Map<String, String> locationInfo = await LocationHelper.getCurrentLocation();
    Map<String, dynamic> data = signUpModel.toJson();
    data.addAll(deviceInfo);
    data.addAll(locationInfo);
