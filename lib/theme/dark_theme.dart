...
ThemeData dark = ThemeData(
  ...
  primaryColor: const Color(0xFFF40E26),
  secondaryHeaderColor: const Color(0x9BF40E26),
  ...
  colorScheme: const ColorScheme.dark(primary: Color(0xFFCF0F14),
      tertiary: Color(0xff6165D7),
      tertiaryContainer: Color(0xff171DB6),
      secondary: Color(0x9BCF0F14)).copyWith(surface: const Color(0xFF272727)).copyWith(error: const Color(0xFFdd3135),
  ),
