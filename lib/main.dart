...
Future<void> main() async {
  ...
  if(GetPlatform.isWeb) {
    await Firebase.initializeApp(
      ...
      apiKey: "AIzaSyCoJyDVkVvtLWQ-uK8btV50jssr64n2Iq0",
      projectId: "foodpluses2",
      messagingSenderId: "760579118951",
      appId: "1:760579118951:web:516dcbd5e612dd5cf8c1c2",
    ));
    MetaSEO().config();
    ...
    await Firebase.initializeApp(
      name: 'foodpluses',
      options: const FirebaseOptions(
        apiKey: "AIzaSyB1KCczc-l4pNukaijguir6tXLB--WotXs",
        projectId: "foodpluses2",
        messagingSenderId: "760579118951",
        appId: "1:760579118951:android:1f2a5d9986b772d7f8c1c2",
      ),
    );
  } else {
    await Firebase.initializeApp();
