...
import 'package:stackfood_multivendor/features/cart/screens/combined_cart_checkout_screen.dart';
...
import 'package:stackfood_multivendor/features/faq/screens/faq_screen.dart';
...
class RouteHelper {
  ...
  static const String combinedCartCheckout = '/combined-cart-checkout';
  ...
  static String getCombinedCartCheckoutRoute({bool fromReorder = false, bool fromDineIn = false}) => '$combinedCartCheckout?from_reorder=$fromReorder&from_dine_in=$fromDineIn';
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: combinedCartCheckout, page: () => getRoute(CombinedCartCheckoutScreen(fromNav: false, fromReorder: Get.parameters['from_reorder'] == 'true', fromDineIn: Get.parameters['from_dine_in'] == 'true'))),
    ...
    GetPage(name: faq, page: () => getRoute(const FaqScreen())),
  ];
